# second_repository
Основы статистики
Дана входная таблица website_visits_december_2024.csv, содержащая информацию о пользовательском поведении на сайте за декабрь 2024 года. В ней описаны следующие столбцы:
...
* Рассчитайте коэффициент вариации и сделайте вывод о том, насколько изменчиво поведение пользователей сайта в зависимости от времени нахождения на сайте. При коэффициенте вариации более 0.25 выведите строку "Высокая вариабельность", при коэффициенте менее 0.25 и более 0.1 выведите строку "Умеренная вариабельность", ниже 0.1 - "Слабая вариабельность", после этого выведите сам коэффициент.

* Проверьте, есть ли статистически значимая разница в количестве страниц, просмотренных пользователями с мобильных устройств и десктопов. Результат оформите в виде строки "Есть статистически значимая разница в количестве страниц", если p_value больше 0.05, иначе "Нет статистически значимой разницы", после этого выведите само p_value.

  **Как должен выглядеть вывод для функции:**
